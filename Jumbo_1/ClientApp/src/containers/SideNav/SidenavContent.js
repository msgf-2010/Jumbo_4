        ...
        return (
            <CustomScrollbars className=" scrollbar">
                <ul className="nav-menu">
                    ...
                    <li className="menu collapse-box">
                        <Button>
                            <i className="zmdi zmdi-format-queue-music zmdi-hc-fw" />
                            <span className="nav-text">
                                <IntlMessages id="sidebar.gadgets" />
                            </span>
                        </Button>
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/app/projects/counter">
                                    <span className="nav-text"><IntlMessages id="sidebar.gadgets.counter" /></span>
                                </NavLink>
                            </li>
                        </ul>
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/app/projects/peopleTable">
                                    <span className="nav-text"><IntlMessages id="sidebar.gadgets.peopleTable" /></span>
                                </NavLink>
                            </li>
                        </ul>
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" to="/app/projects/contacts">
                                    <span className="nav-text"><IntlMessages id="sidebar.gadgets.contacts" /></span>
                                </NavLink>
                            </li>
                        </ul>
                        <ul className="sub-menu">
